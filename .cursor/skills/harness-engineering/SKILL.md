...
| **变更档位 / 定级** | `.ai/planning/README.md`、`tier-classification` gate |
| **生命周期 / 状态机** | `.ai/workflows/agent-lifecycle.md` |
| T0 Bug | `bugfix` skill、`.ai/fixes/README.md` |
| T1–T3 设计 | `requirements-design` skill |
| 规格偏差回流 | `.ai/workflows/spec-deviation.md` |
| UI 布局 / 滚动 / 视觉 | `css-layout`、`scrollable-layout`、`macbook-ui` |
| **落盘约定** | `.ai/planning/README.md` |
| 完整功能流程 | `.ai/workflows/feature-development.md` |
| 实现后自验 | `.ai/gates/post-implementation.md` |
