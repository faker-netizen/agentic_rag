...
export const DOMAIN_SKILL_MAX_AGENT_STEPS = 6;
export const SSE_STATUS_LABEL_MAX = 32;
export const SSE_HEARTBEAT_INTERVAL_MS = 20_000;

export const DOCUMENT_SUMMARY_MAX_INPUT_CHARS = 12_000;
export const DOCUMENT_SUMMARY_MAX_OUTPUT_CHARS = 800;
export const DOCUMENT_SUMMARY_PREVIEW_CHARS = 120;
export const CATALOG_CONTEXT_MAX_CHARS = 24_000;
export const DOCUMENT_JOB_POLL_MS = 2000;

export const CHATPDF_MAX_PAGES = 200;
export const PDF_SUMMARY_MAX_INPUT_CHARS = 48_000;
export const PDF_SUMMARY_BULLET_MIN = 5;
export const PDF_SUMMARY_BULLET_MAX = 12;
export const PDF_SUMMARY_CITE_IDS_MAX = 3;
export const PDF_CITATION_EXCERPT_MIN = 8;
export const PDF_CITATION_EXCERPT_MAX = 200;
export const PDF_EXCERPT_FUZZY_PREFIX_LEN = 24;
